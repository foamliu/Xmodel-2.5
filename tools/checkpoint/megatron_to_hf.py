...
def convert_checkpoint(args):
    ...
    config = XmodelConfig.from_name(name=args.hf_model_name)
...
def copy_huggingface_tokenizer(dst_path):
    ...
    os.system("cp -rf models/configuration_xmodel.py " + dst_path)
    os.system("cp -rf models/modeling_xmodel.py " + dst_path)
