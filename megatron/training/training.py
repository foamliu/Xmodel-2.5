...
def setup_model_and_optimizer(model_provider_func,
    ...
    if no_wd_decay_cond is None:
        if config.no_decay_norm_bias_embed:
            no_wd_decay_cond = lambda name, param: (
                'norm' in name or 'bias' in name or 'embedding' in name
            )
        elif config.no_decay_norm_bias:
            no_wd_decay_cond = lambda name, param: (
                'norm' in name or 'bias' in name
            )
