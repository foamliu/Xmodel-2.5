...
class OptimizerConfig:
    ...
    # Weight decay.
    no_decay_norm_bias_embed: bool = False
    """If true, norm, bias and embedding parameters will not be decayed by weight decay"""

    no_decay_norm_bias: bool = False
    """If true, norm and bias parameters will not be decayed by weight decay"""
