...
class XmodelConfig(PretrainedConfig):
    ...
    def __init__(
            ...
            intermediate_size: Optional[int] = 3840,
...
xmodel_configs = {
    ...
    "xl": dict(num_hidden_layers=48,
               num_attention_heads=24,  # Must be >= num_key_value_heads
               num_key_value_heads=8,  # Matches checkpoint's 192/(1536/64)
               hidden_size=1536,
               tie_word_embeddings=True,
               intermediate_size=3840),  # Matches checkpoint's down_proj shape
