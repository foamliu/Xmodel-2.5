...
class MegatronHPO:
    ...
    def _build_model(self, trial):
        ...
        params = {
            ...
            "init_std": trial.suggest_float("init_std", 0.9, 1.1),
            "mup_input_scale": trial.suggest_float("mup_input_scale", 0.1, 20, log=True),
            "mup_output_scale": trial.suggest_float("mup_output_scale", 0.1, 20, log=True),
            "mup_attention_residual_scale": trial.suggest_float("mup_attention_residual_scale", 10, 10 ** +3, log=True),
            "mup_ffn_residual_scale": trial.suggest_float("mup_ffn_residual_scale", 10 ** -3, 10, log=True)
        }
