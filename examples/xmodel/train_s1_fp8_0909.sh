...
CHECKPOINT_PATH=out/i_line_s1_fp8_0909
TENSORBOARD_LOGS_PATH=runs/i_line_s1_fp8_0909
...
GPT_MODEL_ARGS=(
    ...
    --disable-bias-linear
    --use-mup
    --mup-input-scale 20.0
    --mup-output-scale 2.6
    --mup-attention-residual-scale 15.0
    --mup-ffn-residual-scale 20.0
)
...
TRAINING_ARGS=(
    ...
    --adam-beta2 0.95
    --clip-grad 1.0
    --lr 0.004      # 0.01 / sqrt(1536/256) ≈ 0.004
    --decoupled-lr 0.01
