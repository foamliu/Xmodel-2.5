...
# Runs the FP8 training script with Multi-Latent Attention (MLA) architecture
# Combines techniques from FP8 training with MLA-specific parameters
...
CHECKPOINT_PATH=out/fp8_muon_mla
TENSORBOARD_LOGS_PATH=runs/megatron_lm_1b_fp8_muon_mla
