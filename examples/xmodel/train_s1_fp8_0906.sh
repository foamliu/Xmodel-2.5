...
CHECKPOINT_PATH=out/i_line_s1_fp8_0906
TENSORBOARD_LOGS_PATH=runs/i_line_s1_fp8_0906
...
GPT_MODEL_ARGS=(
    ...
    --hidden-dropout 0.0
    --swiglu
    --init-method-std 0.06
    --attention-backend fused
    --use-flash-attn
    --normalization RMSNorm
    --disable-bias-linear
    --use-mup
    --mup-input-scale 36.0
    --mup-output-scale 2.0
    --mup-attention-residual-scale 15.0
    --mup-ffn-residual-scale 40.0
)
