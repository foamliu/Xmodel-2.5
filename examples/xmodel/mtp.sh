...
# Runs the FP8 training script with Muon optimizer and Multi-Token-Prediction
# Combines FP8, Muon and MTP techniques
...
CHECKPOINT_PATH=out/fp8_muon_mtp
TENSORBOARD_LOGS_PATH=runs/megatron_lm_1b_fp8_muon_mtp
