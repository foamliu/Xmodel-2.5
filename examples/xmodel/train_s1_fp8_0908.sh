...
CHECKPOINT_PATH=out/i_line_s1_fp8_0908
TENSORBOARD_LOGS_PATH=runs/i_line_s1_fp8_0908
...
GPT_MODEL_ARGS=(
    ...
    --hidden-dropout 0.0
    --swiglu
    --init-method-std 0.05
    --attention-backend fused
    --use-flash-attn
    --normalization RMSNorm
    --disable-bias-linear
    --use-mup
    --mup-input-scale 30.0
    --mup-output-scale 1.6
    --mup-attention-residual-scale 17.2
    --mup-ffn-residual-scale 17.0
)
