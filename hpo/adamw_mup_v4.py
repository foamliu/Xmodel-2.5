...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "init_std": trial.suggest_float("init_std", 0.0, 0.1),
            "mup_input_scale": trial.suggest_float("mup_input_scale", 0, 100),
            "mup_output_scale": trial.suggest_float("mup_output_scale", 0, 6),
            "mup_attention_residual_scale": trial.suggest_float("mup_attention_residual_scale", 0, 25),
            "mup_ffn_residual_scale": trial.suggest_float("mup_ffn_residual_scale", 0, 25)
        }
        ...
        lr_hidden = learning_rate / math.sqrt(mup_width_multiplier)
        ...
        mup_input_scale = 30.0
        mup_output_scale = 1.6
        mup_attention_residual_scale = 17.2
        mup_ffn_residual_scale = 17.0
