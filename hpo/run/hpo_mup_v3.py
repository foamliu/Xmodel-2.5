...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        # 超参数采样
        params = {
            "learning_rate": trial.suggest_float("learning_rate", 2 ** (-13), 2 ** (-6), log=True),
            "use_muon": trial.suggest_categorical('use_muon', [True, False]),
            "use_fp8": trial.suggest_categorical('use_fp8', [True, False]),
            ...
            "mup_output_scale": trial.suggest_float("mup_output_scale", 1.0, 2.0),
