...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        init_std = 0.7684243289772825
        mup_input_scale = 0.009350692686916321
        mup_output_scale = 3.3813847646997552
        mup_attention_residual_scale = 0.03600486455598032
        mup_ffn_residual_scale = 0.0019072421409102565
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1):
        ...
        study = optuna.create_study(
            direction="minimize",
            sampler=sampler,
            study_name="muon_mup_depth_transfer_v11"
        )
...
if __name__ == "__main__":
    ...
    learning_rate_range = [2 ** x for x in range(-8, 8)]
