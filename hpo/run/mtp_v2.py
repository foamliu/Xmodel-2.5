...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "mtp_scale": trial.suggest_float("mtp_loss_scaling_factor", 0.01, 3.0, log=True)
        }
        ...
        if mtp_num_layers > 0:
            cmd += [
                "--mtp-loss-scaling-factor", str(mtp_scale),
