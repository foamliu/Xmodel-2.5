...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "init_std": trial.suggest_float("init_std", 0.5, 2.0),
            "mup_input_scale": trial.suggest_float("mup_input_scale", 0.0, 2.0),
            "mup_output_scale": trial.suggest_float("mup_output_scale", 0.0, 2.0),
            "mup_attention_residual_scale": trial.suggest_float("mup_attention_residual_scale", 0.0, 2.0),
            "mup_ffn_residual_scale": trial.suggest_float("mup_ffn_residual_scale", 0.0, 10.0)
        }
