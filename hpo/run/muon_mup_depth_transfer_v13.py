...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        init_std = 1 / math.sqrt(hidden_size)
        mup_input_scale = 1.0
        mup_output_scale = 1.0
        mup_attention_residual_scale = 1.0
        mup_ffn_residual_scale = 1.0

        lr_embedding = learning_rate / math.sqrt(vocab_size)
        lr_hidden = learning_rate / math.sqrt(hidden_size)
        train_iters = 500
