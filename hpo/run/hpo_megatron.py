...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "global_batch_size": trial.suggest_int("global_batch_size", 24, 480, step=24),  # Must be multiple of 24
        }
        ...
        train_iters = round(500 * mup_width_multiplier * mup_depth_multiplier * batch_size_multiplier)  # 根据hidden_size调整训练迭代次数
