...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        # 超参数采样
        params = {
            "learning_rate": trial.suggest_float("learning_rate", 2 ** (-6), 2 ** (-1), log=True),
        }
        ...
        use_mup = True
        init_std = 0.0636086751507936
        mup_input_scale = 15.822221213310598
        mup_output_scale = 1.5119977019679969
        mup_attention_residual_scale = 7.720138434724928
        mup_ffn_residual_scale = 1.6788935011097403
