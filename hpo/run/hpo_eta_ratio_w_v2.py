...
class MegatronHPO:
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1, hidden_size=256):
        """
        运行超参数优化
...
if __name__ == "__main__":
    ...
    for hidden_size in [2048]:
        logger.info(f"Starting HPO with hidden size: {hidden_size}")
