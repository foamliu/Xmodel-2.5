...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        if params["use_mup"]:
            cmd += ["--use-mup",
                    "--mup-input-scale", "11.664572869958262",
                    "--mup-output-scale", "1.5090392463211413",
                    "--mup-attention-residual-scale", "6.378735548561413",
                    "--mup-ffn-residual-scale", "2.2111775509710574",
                    ]
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1):
        ...
        study = optuna.create_study(
            direction="minimize",
            sampler=sampler,
            study_name="muon_mup_depth_transfer_v7"
        )
...
if __name__ == "__main__":
    ...
    learning_rate_range = [2 ** (x * 0.5) for x in range(-20, -3)]
