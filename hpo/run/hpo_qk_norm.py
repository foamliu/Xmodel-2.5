...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "qk_layernorm": trial.suggest_categorical('qk_layernorm', [True, False]),
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1):
        ...
        n_trials = len(search_space["learning_rate"]) * len(search_space["qk_layernorm"]) * len(
