...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "use_mla": trial.suggest_categorical('use_mla', [True, False]),
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1):
        ...
        n_trials = len(search_space["learning_rate"]) * len(search_space["use_mla"]) * len(
