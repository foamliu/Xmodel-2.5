...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "hidden_size": trial.suggest_categorical("hidden_size", [64, 128, 256, 512, 1024, 1536]),
        }
        ...
        mup_input_scale = 20.0
        mup_output_scale = 2.6
        mup_attention_residual_scale = 15.0
        mup_ffn_residual_scale = 20.0

        sigma_0 = 1.0
        init_method_std = sigma_0 / hidden_size ** 0.5
        decoupled_init_std = sigma_0 / vocab_size ** 0.25
        ...
        cmd = [
            ...
            "--decoupled-init-std", str(decoupled_init_std),
    ...
    def optimize(self, n_trials=50, timeout=None, n_jobs=1):
        ...
        search_space = {
            ...
            "use_mup": [True, False],
            "hidden_size": [64, 128, 256, 512, 1024, 1536]
        }
        ...
        study = optuna.create_study(
            direction="minimize",
            sampler=sampler,
            study_name="muon_mup_width_transfer_v15"
        )
...
if __name__ == "__main__":
    ...
    learning_rate_range = [2 ** i for i in range(-15, -2)]
