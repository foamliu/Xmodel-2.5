...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "mup_input_scale": trial.suggest_float("mup_input_scale", 2**-10, 2**10, log=True),
            "mup_output_scale": trial.suggest_float("mup_output_scale", 2**-10, 2**10, log=True),
            "mup_attention_residual_scale": trial.suggest_float("mup_attention_residual_scale", 2**-10, 2**10, log=True),
            "mup_ffn_residual_scale": trial.suggest_float("mup_ffn_residual_scale", 2**-10, 2**10, log=True)
        }
        ...
        lr_hidden = learning_rate / mup_width_multiplier
