...
class MegatronHPO:
    ...
    def _build_train_command(self, trial, trial_dir):
        ...
        params = {
            ...
            "mup_input_scale": trial.suggest_float("mup_input_scale", 0, 50),
            "mup_output_scale": trial.suggest_float("mup_output_scale", 0, 50),
            "mup_attention_residual_scale": trial.suggest_float("mup_attention_residual_scale", 0, 50),
            "mup_ffn_residual_scale": trial.suggest_float("mup_ffn_residual_scale", 0, 50)
        }
