...
def get_argument_parser():
    ...
    parser.add_argument("--data_path", type=str,
                        default='/data12/datasets/Ultra-FineWeb/data/ultrafineweb_en/ultrafineweb-en-part-0001-of-2048.parquet')
    parser.add_argument("--output_dir", type=str, default='/data13/datasets/pretrain/ultrafineweb-en_json/')
    return parser
